...
- I am proficient in the use of CAD software
...
## Projects
### Model Rocket design
- Designed a model rocket using OpenRocket CAD
- Calculated the rocket's flight
- Built a model of the rocket in Solidworks.
- 3D printed the nose cone
